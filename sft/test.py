...
import sys
sys.path.append('../part3_pretraining')
from pretraining_fixed import SimpleTokenizer, SimpleTransformer
...
if __name__ == "__main__":
    ...
    try:
        ...
        checkpoint = torch.load('../pretrained_model.pt', map_location='cpu')
