...
class RetailDataGenerator:
    ...
    def _generate_conversation_text(self) -> str:
        ...
        templates = [
            ...
            "The jeans I bought last month tore very easily and I'm disappointed",
            "Can you help me find wireless headphones with noise cancellation?",
            "I need running shoes that are comfortable for long distances",
            "What payment methods do you accept for international orders?",
            "The laptop I ordered arrived damaged, how do I get a refund?",
            "Do you have this shirt in a larger size and different color?",
            "I want to track my package that was supposed to arrive yesterday",
            "Can you recommend a good quality backpack for hiking trips?",
            "The product photo looks different from what I actually received",
            "I need help choosing between these two smartphone models",
            "What is the warranty period for electronic devices?",
            "My credit card was charged twice for the same order",
            "Can I exchange this jacket for a different style?",
            "Looking for eco-friendly and sustainable clothing options",
            "The customer service representative was very helpful yesterday",
            "I want to cancel my order before it ships tomorrow",
            "Do you offer student discounts on laptops and tablets?",
            "The shoes are too tight, can I return them after wearing once?",
            "I need a birthday gift for my sister who loves reading",
            "What are the shipping costs for express delivery options?",
            "The product arrived on time but the box was severely damaged",
            "Can you price match if I found this cheaper elsewhere?",
            "I love this brand and have been a loyal customer for years",
            "Looking for waterproof jackets suitable for rainy weather conditions",
            "The battery life on this device is much shorter than advertised",
            "Can you send me the instruction manual for this product?",
            "I want to upgrade my order to premium shipping before it leaves",
            "Do you have any promotions or sales happening this weekend?",
            "The quality of materials seems poor compared to previous versions",
            "I need technical support for setting up my new wireless router",
            "Can I add another item to my existing order that hasn't shipped?",
            "What is your policy on returns for opened electronics?",
            "I received the wrong item and need to exchange it immediately",
            "Looking for vegan leather handbags that are stylish and affordable",
            "The sizing chart on your website seems inaccurate for clothing",
            "Can you recommend kitchen appliances that are energy efficient?",
            "I want to file a complaint about the rude customer service agent",
            "Do you ship to rural areas and what are the delivery times?",
            "The promotional code isn't working at checkout, please help",
            "I need durable furniture that can withstand kids and pets",
            "What are the best-selling products in your sports equipment category?",
            "The item was listed as new but appears to be refurbished",
            "Can I get a gift receipt without showing the price?",
            "I'm allergic to certain materials, what are the fabric contents?"
        ]
